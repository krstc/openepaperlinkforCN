...
void showSplashScreen() {
    ...
    switch (tag.solumType) {
        ...
        case STYPE_SIZE_037_UC8253:
            ...
            fr.epdPrintf(2, 2, COLOR_BLACK, rotation::ROTATE_0, "OpenEPaperLink");
            fr.setFont(&FreeSans9pt7b);
            fr.epdPrintf(10, 38, COLOR_RED, rotation::ROTATE_0, "Newton M3 UC8253 3.7\"");
            fr.epdPrintf(epd->Xres - 17, 0, COLOR_BLACK, rotation::ROTATE_270, "FW: %04X-%s", fwVersion, fwVersionSuffix);
            fr.epdPrintf(5, epd->Yres - 20, COLOR_BLACK, rotation::ROTATE_0, "MAC: %02X:%02X:%02X:%02X:%02X:%02X:%02X:%02X", mSelfMac[7], mSelfMac[6], mSelfMac[5], mSelfMac[4], mSelfMac[3], mSelfMac[2], mSelfMac[1], mSelfMac[0]);
            addQR(epd->Xres - 120, 92, 3, 3, "https://openepaperlink.eu/tag/0/%02X/%02X%02X%02X%02X%02X%02X%02X%02X/", tag.OEPLtype, mSelfMac[7], mSelfMac[6], mSelfMac[5], mSelfMac[4], mSelfMac[3], mSelfMac[2], mSelfMac[1], mSelfMac[0]);
            break;
        case STYPE_SIZE_043:
        ...
        case STYPE_SIZE_75_JD79665_BWRY_NEW:
            ...
            fr.epdPrintf(10, 10, COLOR_BLACK, rotation::ROTATE_0, "OpenEPaperLink");
            fr.setFont(&FreeSansBold18pt7b);
            fr.epdPrintf(15, 60, COLOR_RED, rotation::ROTATE_0, "Newton M3 JD79665");
            fr.epdPrintf(15, 100, COLOR_YELLOW, rotation::ROTATE_0, "768x552 BWRY");
            fr.setFont(&FreeSans9pt7b);
            fr.epdPrintf(epd->Xres - 17, 310, COLOR_BLACK, rotation::ROTATE_270, "FW: %04X-%s", fwVersion, fwVersionSuffix);
